...
public class Human implements Activities {
    ...
    public Human(String name, int maxJumpLimit, int maxRunLimit) {
        this.name = name;
    ...
    public void jump(int hight) {
        ...
        System.out.println("Human "+name+" overcome this barrier");
        else{
            System.out.println("Human "+name+" can`t jump this barrier");
            canTakePart=false;
        }
    }
    ...
    public void run(int distance) {
        if(distance<maxRunLimit){
            System.out.println("Human "+name+" overcome this running");
        }
        else{
            System.out.println("Human "+name+" can`t overcome this barrier");
            canTakePart=false;
        }
    }
}
