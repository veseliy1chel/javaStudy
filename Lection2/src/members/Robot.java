...
public class Robot implements Jumpable,Runnable {
    ...
    public Robot(String name, int maxJumpLimit, int maxRunLimit) {
        this.name = name;
    ...
    public void jump(int hight) {
        if(hight<maxJumpLimit)
            System.out.println("Robot "+name+" overcome this barrier");
        else{
            System.out.println("Robot "+name+" can`t jump this barrier");
            canTakePart=false;
        }
    }
    ...
    public void run(int distance) {
        if(distance<maxRunLimit){
            System.out.println("Robot "+name+" overcome this running");
        }
        else{
            System.out.println("Robot "+name+" can`t overcome this barrier");
            canTakePart=false;
        }
    }
}
